						...
						{else}
							...
							<div class="col-lg-12 col-sm-12">
								<div class="card">
									<div class="card-main">
										<div class="card-inner">
											<p class="card-heading">我要注册</p>
												<a class="btn btn-flat waves-attach waves-light waves-effect" href="/auth/register"><span class="icon">pregnant_woman</span>&nbsp;客官可以点这里注册吧。</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-12 col-sm-12">
								<div class="card">
									<div class="card-main">
										<div class="card-inner">
											<p class="card-heading">我要登录</p>
												<a class="btn btn-flat waves-attach waves-light waves-effect" href="/auth/login"><span class="icon">vpn_key</span>&nbsp;客官可以点这里登录吧。</a>
										</div>
									</div>
								</div>
							</div>
